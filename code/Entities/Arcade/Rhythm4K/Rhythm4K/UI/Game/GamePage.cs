...
public partial class GamePage
{
    ...
    private void OnFrame()
    {
        ...
        // Check for BPM Change
            ...
            bool[] pressed = {
            Input.Pressed("RhythmLeft"),
            Input.Pressed("RhythmDown"), 
            Input.Pressed("RhythmUp"),
            Input.Pressed("RhythmRight")
        };

        bool[] held = {
            Input.Down("RhythmLeft"),
            Input.Down("RhythmDown"),
            Input.Down("RhythmUp"),
            Input.Down("RhythmRight")
        };
