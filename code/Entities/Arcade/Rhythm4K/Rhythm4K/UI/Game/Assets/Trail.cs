...
public partial class Trail : Panel
{
    ...
    public Trail()
    {
        ...
        TrailTrunk.SetTexture("/sprites/arcade/rhythm4k/arrows/alloy/hold.png");
        ...
        {
            AddClass("downscroll");
            TrailCap.SetTexture("/sprites/arcade/rhythm4k/arrows/alloy/hold-cap-downscroll.png");
        }
        else
        {
            TrailCap.SetTexture("/sprites/arcade/rhythm4k/arrows/alloy/hold-cap.png");
        }
    }
